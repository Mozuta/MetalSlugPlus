...
import com.example.fifteen.export.ExportCallback;
import com.example.fifteen.export.Exporter;
import com.example.fifteen.export.RecordsExporter;
import com.example.fifteen.export.SessionExporter;
import com.example.metalslug.R;

public class PuzzleActivity extends Activity implements ExportCallback {
    ...
    private final Exporter.Callback exportCallback = new Exporter.Callback() {
        ...
        public void onSuccess(int count) {
            Toast.makeText(PuzzleActivity.this, getString(R.string.export_success, count), Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onError() {
            Toast.makeText(PuzzleActivity.this, R.string.export_import_failure, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private final Exporter.Callback importCallback = new Exporter.Callback() {
        @Override
        public void onSuccess(int count) {
            Toast.makeText(PuzzleActivity.this, getString(R.string.import_success, count), Toast.LENGTH_SHORT).show();
        }
