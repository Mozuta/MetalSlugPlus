package com.example.fifteen.views.help;
...
import com.example.fifteen.TileAppearAnimator;
import com.example.fifteen.views.FieldView;
import com.example.fifteen.views.overlay.FieldOverlay;
...
public class HelpOverlay extends FieldOverlay {
    ...
    public HelpOverlay(Resources res, TileAppearAnimator tileAppearAnimator, RectF rect, RectF fieldRect) {
        ...
        mPaintText.setTextSize(Dimensions.interfaceFontSize * 5.4f);
